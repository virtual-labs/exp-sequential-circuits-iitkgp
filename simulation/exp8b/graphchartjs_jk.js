...
function jplot(){
  ...
  for (var tabrowindex = 1; tabrowindex < table.rows.length; tabrowindex++) {
    ...
    dataPointj.push( { y: parseFloat(rwe1[1].innerHTML)});
    
}
  var chartj = new CanvasJS.Chart("chartContainerj", {
    animationEnabled: true,
    exportEnabled: true,
    animationDuration: 7000,
    colorSet:  "greenShades",
...
function kplot(){
  ...
  for (var tabrowindex = 1; tabrowindex < table.rows.length; tabrowindex++) {
    ...
    dataPointk.push( { y: parseFloat(rwe1[2].innerHTML)});
    
}
  var chartk = new CanvasJS.Chart("chartContainerk", {
    animationEnabled: true,
    exportEnabled: true,
    animationDuration: 7000,
    colorSet:  "greenShades",
